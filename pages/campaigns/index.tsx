...
const Home: NextPage = () => {
  ...
  return (
    <>
      {key != "" && (
        <div className="fixed z-10 top-0 bottom-0 left-0 right-0 bg-black/30 flex justify-center items-center">
          <div className="bg-white w-96 py-12 px-4 rounded-lg">
            <h2 className="text-2xl">
              Are you sure you want to delete this campaign?
            </h2>
            <p className="text-sm text-gray-400">
              all data with applications to this campaign would be deleted
            </p>
            <div className="flex justify-center items-center mt-4">
              <button
                className="bg-red-600 text-white px-8 py-2 mx-4 rounded-md"
                onClick={remove}
              >
                yes
              </button>
              <button
                className="text-blue-600 px-8 py-2 mx-4 rounded-md"
                onClick={() => setKey("")}
              >
                no
              </button>
        ...
        <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
          <div className="sm:flex items-center justify-between">
            ...
            <button
              ...
              className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-blue-700 hover:bg-blue-900 focus:outline-none rounded"
            >
